...
function BarMenu({ handleCategChange }) {
    ...
    const categories = ["Engagement", "Holiday", "Everyday", "Cocktail", "All"];
            ...
            <aside className="sidebar">
                <div id="hmenu-customer-profile-link" data-nav-ref="nav_em_hd_re_signin">
                    <div id="hmenu-customer-profile">
                        <div className="customer-profile"> <span className="profile-icon"><i className="far fa-user-circle"></i></span> Choose another filter</div>
