...
function CartScreen(props) {
  ...
  const countItems = () => {
    return cartItems.reduce((a, c) => parseInt(a) + parseInt(c.Quantity), 0);
  }
                  ...
                  <li key={item._id} className="cart-item">
                    <div className="cart-container">
                      ...
                      <div className="cart-item-details">
                        <div className="cart-name">
                          ...
                          <div className="item-Quantity">
                            Quantity:
                          <select className="item-Quantity-btn" value={item.Quantity} onChange={(e) => dispatch(addToCart(item.product, e.target.value))}>
                      ...
                      <div className="cart-price">
                        <h3 className="item-price">${(item.price * item.Quantity).toFixed(2)} </h3>
                      </div>
                    </div>
                  </li>
                )
