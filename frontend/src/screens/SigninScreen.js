          ...
          <ul className="form-container">
            ...
            <li>
              <div className="divide-breaker">
                <p className="signin-new"> <span style={{background: '#123566', padding: '2rem',width: '2pt'}}>New to ReJewel?</span>  </p>
              </div>
            </li>
            <li>
              <Link to={redirect === "/" ? "register" : "register?redirect=" + redirect} className="create-new-btn" >Create your ReJewel account</Link>
            </li>
          </ul>
        </form>
      </div>
