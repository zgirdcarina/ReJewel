...
//         const { data, predictedClass } = action.payload;
//         return { loading: false, success: true, product: { ...data, predictedClass } };
//       case PRODUCT_SAVE_FAIL:
//         return { loading: false, error: action.payload };
//       default:
//         return state;
...
export {
    productListReducer, productDetailsReducer, productDeleteReducer, productSaveReducer,
